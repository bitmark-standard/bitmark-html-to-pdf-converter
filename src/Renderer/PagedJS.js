...
exports.PagedJS = void 0;
var fs = require("fs");
var path = require("path");
var AbstractRenderer_1 = require("./AbstractRenderer");
var child_process_1 = require("child_process");
var fsExtra = require("fs-extra");
var PagedJS = /** @class */ (function (_super) {
    __extends(PagedJS, _super);
    function PagedJS() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    PagedJS.prototype.getRendererName = function () {
        return "PagedJS";
    };
    PagedJS.prototype.getPDF = function (html, css) {
        ...
        var hasError = false;
        try {
            (0, child_process_1.execSync)("".concat(this.command, " -i ").concat(inputPath, " -o ").concat(outputPath, " &>").concat(logPath));
        }
        catch (error) {
            hasError = true;
        }
