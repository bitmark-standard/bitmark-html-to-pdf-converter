...
exports.AHFormatter = void 0;
var fs = require("fs");
var path = require("path");
var AbstractRenderer_1 = require("./AbstractRenderer");
var child_process_1 = require("child_process");
var fsExtra = require("fs-extra");
var AHFormatter = /** @class */ (function (_super) {
    __extends(AHFormatter, _super);
    function AHFormatter() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    AHFormatter.prototype.getRendererName = function () {
        return "AH Formatter";
    };
    AHFormatter.prototype.getPDF = function (html, css) {
        ...
        var hasError = false;
        try {
            (0, child_process_1.execSync)("".concat(this.command, " -d ").concat(inputPath, " -o ").concat(outputPath, " &>").concat(logPath));
        }
        catch (error) {
            hasError = true;
        }
...
exports.AHFormatter = AHFormatter;
